...
gcs_file_path = "Mandic_DataProc/output/tabelas_para_ingestao_slmandicararasprd.json"
local_file_path = "/tmp/tabelas_para_ingestao_slmandicararasprd.json"
    ...
    for table_name in tables:
        ...
        dataproc_job = DataprocSubmitJobOperator(
            ...
            job={
                ...
                "pyspark_job": {
                    "main_python_file_uri": "gs://bucket-slmandic-datalake-hml/Mandic_DataProc/Script_DataProc/spark_ingest_slmandicararasprd.py",
                    "args": [
                        table_name,
                        f"--db_user={db_user}",
...
with DAG(
    dag_id="ingest_slmandicararasprd",
    schedule_interval=None,
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    tags=["ingestao", "slmandicararasprd"],
) as dag:
