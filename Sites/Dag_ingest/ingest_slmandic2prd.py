...
# =========================================
# Configurações do Secret Manager
# =========================================
# Nome dos segredos no Secret Manager
# Substitua os nomes com os IDs dos seus segredos
# DB_USER_SECRET_ID = "username"
# DB_PASSWORD_SECRET_ID = "password"
...
gcs_file_path = "Mandic_DataProc/output/tabelas_para_ingestao_slmandic2prd.json"
local_file_path = "/tmp/tabelas_para_ingestao_slmandic2prd.json"
    ...
    for table_name in tables:
        ...
        dataproc_job = DataprocSubmitJobOperator(
            ...
            job={
                ...
                "pyspark_job": {
                    "main_python_file_uri": "gs://bucket-slmandic-datalake-hml/Mandic_DataProc/Script_DataProc/spark_ingest_slmandic2prd.py",
                    "args": [
                        table_name,
                        f"--db_user={db_user}",
...
with DAG(
    dag_id="ingest_slmandic2prd",
    schedule_interval=None,
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    tags=["ingestao", "slmandic2prd"],
) as dag:
