...
data_base = "slmandicptprd_raw"
secret_name = "mandic-slmglpi"

# Configurações do banco de dados (o restante é fixo)
#jdbc_url = "jdbc:mysql://slm-sites.c0appmybhqbr.us-east-1.rds.amazonaws.com:3306/slmandicptprd"
jdbc_url = "jdbc:mysql://slm-sites.c0appmybhqbr.us-east-1.rds.amazonaws.com:3306/slmandicptprd?zeroDateTimeBehavior=CONVERT_TO_NULL"
