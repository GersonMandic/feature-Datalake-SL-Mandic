...
# Define o DAG
with DAG(
    dag_id="controller_medmandicprd",
    schedule_interval="0 12 * * *",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    tags=["controller", "medmandicprd"],
) as dag:
    ...
    verifica_carga = DataprocSubmitJobOperator(
        ...
        job={
            ...
            "pyspark_job": {
                "main_python_file_uri": "gs://bucket-slmandic-datalake-hml/Mandic_DataProc/Script_DataProc/verifica_carga_medmandicprd.py",
                 "args": [
                    f"--db_user={db_user}",
    ...
    trigger_ingest_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="ingest_medmandicprd",
    )
